...
软件的成本可以分解为初始成本和维护成本，我们都知道维护的成本往往是很高的。三个月封闭开发，诞生一个项目，然后花三年甚至更长时间维护。
...
|抽象工厂|跟工厂方法类似，不过抽象工厂可以创建一组对象（有关联的），工厂与产品组一对一|`GUIFactory和WinFactory`|[详](/2016/07/26/clean_code/factory)|
